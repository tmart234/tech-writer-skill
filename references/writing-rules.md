...
> Load this file before the Draft pass (Pass 1) and apply all of it. SKILL.md Step 3 carries the index; this file carries the full set. Companion files: `anti-patterns.md` (what to scan a finished draft for), `how-to-speak.md` and `craft-of-writing.md` (the rhetorical theory behind several of these rules).
