...
- The structural-move pick (Stone, Zalewski, Goodspeed, Schneier-essay, Phineas Fisher) is the same decision as the content-type classification in Pass 0. Stone → vuln writeup, Schneier-essay → essay form, Goodspeed → tutorial-with-stakes, Zalewski → deep dive, Phineas Fisher → how-to with reproducibility discipline. Pick consistently.
